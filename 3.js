...
function saveImage() {
    ...
    ajax.send("pic=" + canvasData + "&id=" + id + '&des=' + "drawing_img");
}


function go_next() {
    var endtime = new Date().getTime()
    wlog("test3 end", endtime)
    wlog("totaltime in test3", endtime - starttime)
    flush_log()
    window.location.href = "change.html?userid=" + id;
}
